...
@*)
    ...
    (*@\vdmnotcovered{(}@*)(*@\vdmnotcovered{name}@*) := (*@\vdmnotcovered{name\_}@*));
...
@*)
    ...
    (
        ...
        metalVol := (*@\vdmnotcovered{SumVolumeGarbagePack}@*)(sortedMap((*@\vdmnotcovered{<METALID>}@*)));
        paperVol := SumVolumeGarbagePack((*@\vdmnotcovered{sortedMap}@*)((*@\vdmnotcovered{<PAPERID>}@*)));
        glassVol := SumVolumeGarbagePack(sortedMap((*@\vdmnotcovered{<GLASSID>}@*)));
        plasticVol := (*@\vdmnotcovered{SumVolumeGarbagePack}@*)((*@\vdmnotcovered{sortedMap}@*)((*@\vdmnotcovered{<PLASTICID>}@*)));
